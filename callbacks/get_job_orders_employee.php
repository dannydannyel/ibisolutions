...
$idEmployee = $_SESSION['id']; // Employee only
...
//Take all the events data including useful join information of current employee
$jobOrderData = $db->getEmployeeTasks($idEmployee);
