...
<?php include_once BASE_PATH . "/inc/parts/breadcrumbs.php";?>
  ...
  <a role="button" class="btn btn-success" href="<?=genUrl("admin/employer/createupdate.php")?>">Nuevo</a>
...
<script>
  $('.btn-update').on('click', (e) => {
    ...
    location.assign("<?=PUBLIC_URL?>admin/employer/createupdate.php?id=" + id);
  });
</script>
