...
$resVillas = $db->getVillaList();
$pageTitle = $pageName = "Villas"; // Valor por defecto
...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <?php require_once BASE_PATH . "inc/parts/common_style.php";?>
...
<?php include_once BASE_PATH . "/inc/parts/breadcrumbs.php";?>
  ...
  <a role="button" href="createupdate.php" class="btn btn-success">Nueva</a>
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Hab./Baños/Piscina</th>
      <th scope="col" colspan="2">Acciones</th>
    </tr>
  </thead>
  <tbody>
    <?php foreach($resVillas as $row):?>
    <tr>
      <th scope="row"><?=$row['id']?></th>
      <td><?=$row['name']?></td>
      <td><?=$row['address']?></td>
      <td><?=$row['owner']?></td>
      <td><?=$row['num_rooms'] . "/" . $row['num_baths'] . "/" . $row['pool']?></td>
...
<script>
  $('.btn-update').on('click', (e) => {
    ...
    location.assign("<?=PUBLIC_URL?>admin/villa/createupdate.php?id=" + id);
  });
</script>
